...
| ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | 
|BERT-Squad| [393 MB](model/bert8.onnx.tar.gz)  |[MD5](BERT-md5-8.txt) |  [788 MB](model/download_sample_8.tar.gz) |  1.3 | 8|
|BERT-Squad| [393 MB](model/bert10.onnx.tar.gz)  |[MD5](BERT-md5-10.txt) |  [788 MB](model/download_sample_10.tar.gz) |  1.5 | 10| 
