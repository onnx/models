# labels: test_group::turnkey name::vgg13_bn author::torch_hub task::Computer_Vision license::bsd-3-clause
"""
...
model = torch.hub.load(
    ...
    "vgg13_bn",
    weights=VGG13_BN_Weights.DEFAULT if pretrained else None,
)
model.eval()
