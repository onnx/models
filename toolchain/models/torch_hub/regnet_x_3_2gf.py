# labels: test_group::turnkey name::regnet_x_3_2gf author::torch_hub task::Computer_Vision license::bsd-3-clause
...
model = torch.hub.load(
    ...
    "regnet_x_3_2gf",
    weights=RegNet_X_3_2GF_Weights.DEFAULT if pretrained else None,
)
model.eval()
