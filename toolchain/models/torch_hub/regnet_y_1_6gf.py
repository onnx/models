# labels: test_group::turnkey name::regnet_y_1_6gf author::torch_hub task::Computer_Vision license::bsd-3-clause
...
model = torch.hub.load(
    ...
    "regnet_y_1_6gf",
    weights=RegNet_Y_1_6GF_Weights.DEFAULT if pretrained else None,
)
model.eval()
