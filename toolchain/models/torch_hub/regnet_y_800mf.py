# labels: test_group::turnkey name::regnet_y_800mf author::torch_hub task::Computer_Vision license::bsd-3-clause
...
model = torch.hub.load(
    ...
    "regnet_y_800mf",
    weights=RegNet_Y_800MF_Weights.DEFAULT if pretrained else None,
)
model.eval()
