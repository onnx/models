# labels: test_group::turnkey name::shufflenet_v2_x2_0 author::torch_hub task::Computer_Vision license::bsd-3-clause
"""
...
model = torch.hub.load(
    ...
    "shufflenet_v2_x2_0",
    weights=ShuffleNet_V2_X2_0_Weights.DEFAULT if pretrained else None,
)
model.eval()
