# labels: test_group::turnkey name::regnet_y_8gf author::torch_hub task::Computer_Vision license::bsd-3-clause
...
model = torch.hub.load(
    ...
    "regnet_y_8gf",
    weights=RegNet_Y_8GF_Weights.DEFAULT if pretrained else None,
)
model.eval()
