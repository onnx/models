# labels: name::resnetv2_101x3_bitm_in21k author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("resnetv2_101x3_bitm_in21k", pretrained = pretrained)
model.eval()
