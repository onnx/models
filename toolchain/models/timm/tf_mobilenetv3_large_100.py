# labels: name::tf_mobilenetv3_large_100 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("tf_mobilenetv3_large_100", pretrained = pretrained)
model.eval()
