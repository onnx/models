# labels: name::gluon_seresnext101_32x4d author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("gluon_seresnext101_32x4d", pretrained = pretrained)
model.eval()
