# labels: name::vit_base_patch32_plus_256 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("vit_base_patch32_plus_256", pretrained = pretrained)
model.eval()
