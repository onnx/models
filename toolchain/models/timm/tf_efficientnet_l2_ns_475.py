# labels: name::tf_efficientnet_l2_ns_475 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("tf_efficientnet_l2_ns_475", pretrained = pretrained)
model.eval()
