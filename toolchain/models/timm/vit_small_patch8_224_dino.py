# labels: name::vit_small_patch8_224_dino author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("vit_small_patch8_224_dino", pretrained = pretrained)
model.eval()
