# labels: name::deit3_huge_patch14_224 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("deit3_huge_patch14_224", pretrained = pretrained)
model.eval()
