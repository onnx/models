# labels: name::deit3_base_patch16_384 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("deit3_base_patch16_384", pretrained = pretrained)
model.eval()
