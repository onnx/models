# labels: name::mobilenetv3_small_075 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("mobilenetv3_small_075", pretrained = pretrained)
model.eval()
