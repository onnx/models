# labels: name::crossvit_18_dagger_408 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("crossvit_18_dagger_408", pretrained = pretrained)
model.eval()
