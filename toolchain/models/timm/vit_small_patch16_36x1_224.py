# labels: name::vit_small_patch16_36x1_224 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("vit_small_patch16_36x1_224", pretrained = pretrained)
model.eval()
