# labels: name::tf_efficientnet_b2_ap author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("tf_efficientnet_b2_ap", pretrained = pretrained)
model.eval()
