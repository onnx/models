# labels: name::gluon_resnext101_64x4d author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("gluon_resnext101_64x4d", pretrained = pretrained)
model.eval()
