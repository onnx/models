# labels: name::beit_base_patch16_224_in22k author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("beit_base_patch16_224_in22k", pretrained = pretrained)
model.eval()
