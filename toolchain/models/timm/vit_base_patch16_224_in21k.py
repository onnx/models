# labels: name::vit_base_patch16_224_in21k author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("vit_base_patch16_224_in21k", pretrained = pretrained)
model.eval()
