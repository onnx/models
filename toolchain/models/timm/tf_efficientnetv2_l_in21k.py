# labels: name::tf_efficientnetv2_l_in21k author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("tf_efficientnetv2_l_in21k", pretrained = pretrained)
model.eval()
