# labels: name::xcit_nano_12_p16_224 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("xcit_nano_12_p16_224", pretrained = pretrained)
model.eval()
