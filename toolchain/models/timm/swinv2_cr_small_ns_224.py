# labels: name::swinv2_cr_small_ns_224 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("swinv2_cr_small_ns_224", pretrained = pretrained)
model.eval()
