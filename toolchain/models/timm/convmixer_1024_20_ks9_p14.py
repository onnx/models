# labels: name::convmixer_1024_20_ks9_p14 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("convmixer_1024_20_ks9_p14", pretrained = pretrained)
model.eval()
