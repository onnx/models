# labels: name::xcit_small_24_p8_224 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("xcit_small_24_p8_224", pretrained = pretrained)
model.eval()
