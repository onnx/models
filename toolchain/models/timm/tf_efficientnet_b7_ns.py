# labels: name::tf_efficientnet_b7_ns author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("tf_efficientnet_b7_ns", pretrained = pretrained)
model.eval()
