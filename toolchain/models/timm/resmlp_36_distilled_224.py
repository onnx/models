# labels: name::resmlp_36_distilled_224 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("resmlp_36_distilled_224", pretrained = pretrained)
model.eval()
