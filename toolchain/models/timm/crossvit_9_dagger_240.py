# labels: name::crossvit_9_dagger_240 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("crossvit_9_dagger_240", pretrained = pretrained)
model.eval()
