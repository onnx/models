# labels: name::mobilenetv3_large_100_miil author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("mobilenetv3_large_100_miil", pretrained = pretrained)
model.eval()
