# labels: name::tf_efficientnetv2_l_in21ft1k author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("tf_efficientnetv2_l_in21ft1k", pretrained = pretrained)
model.eval()
