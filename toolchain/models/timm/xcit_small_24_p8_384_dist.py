# labels: name::xcit_small_24_p8_384_dist author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("xcit_small_24_p8_384_dist", pretrained = pretrained)
model.eval()
