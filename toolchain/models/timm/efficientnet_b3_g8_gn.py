# labels: name::efficientnet_b3_g8_gn author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("efficientnet_b3_g8_gn", pretrained = pretrained)
model.eval()
