# labels: name::efficientnet_b0_g16_evos author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("efficientnet_b0_g16_evos", pretrained = pretrained)
model.eval()
