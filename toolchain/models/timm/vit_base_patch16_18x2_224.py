# labels: name::vit_base_patch16_18x2_224 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("vit_base_patch16_18x2_224", pretrained = pretrained)
model.eval()
