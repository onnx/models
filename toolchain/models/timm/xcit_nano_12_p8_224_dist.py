# labels: name::xcit_nano_12_p8_224_dist author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("xcit_nano_12_p8_224_dist", pretrained = pretrained)
model.eval()
