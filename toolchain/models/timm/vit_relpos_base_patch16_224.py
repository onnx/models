# labels: name::vit_relpos_base_patch16_224 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("vit_relpos_base_patch16_224", pretrained = pretrained)
model.eval()
