# labels: name::gc_efficientnetv2_rw_t author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("gc_efficientnetv2_rw_t", pretrained = pretrained)
model.eval()
