# labels: name::swsl_resnext101_32x8d author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("swsl_resnext101_32x8d", pretrained = pretrained)
model.eval()
