# labels: name::tf_efficientnet_b1_ap author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("tf_efficientnet_b1_ap", pretrained = pretrained)
model.eval()
