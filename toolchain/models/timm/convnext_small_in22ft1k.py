# labels: name::convnext_small_in22ft1k author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("convnext_small_in22ft1k", pretrained = pretrained)
model.eval()
