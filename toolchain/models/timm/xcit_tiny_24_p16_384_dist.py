# labels: name::xcit_tiny_24_p16_384_dist author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("xcit_tiny_24_p16_384_dist", pretrained = pretrained)
model.eval()
