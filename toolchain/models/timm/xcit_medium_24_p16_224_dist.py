# labels: name::xcit_medium_24_p16_224_dist author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("xcit_medium_24_p16_224_dist", pretrained = pretrained)
model.eval()
