# labels: name::swinv2_small_window8_256 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("swinv2_small_window8_256", pretrained = pretrained)
model.eval()
