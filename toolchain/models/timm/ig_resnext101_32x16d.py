# labels: name::ig_resnext101_32x16d author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("ig_resnext101_32x16d", pretrained = pretrained)
model.eval()
