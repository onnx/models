# labels: name::efficientnet_es_pruned author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("efficientnet_es_pruned", pretrained = pretrained)
model.eval()
