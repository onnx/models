# labels: name::lambda_resnet26rpt_256 author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("lambda_resnet26rpt_256", pretrained = pretrained)
model.eval()
