# labels: name::vit_large_patch32_224_in21k author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("vit_large_patch32_224_in21k", pretrained = pretrained)
model.eval()
