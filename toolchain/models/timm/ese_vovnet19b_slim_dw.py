# labels: name::ese_vovnet19b_slim_dw author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("ese_vovnet19b_slim_dw", pretrained = pretrained)
model.eval()
