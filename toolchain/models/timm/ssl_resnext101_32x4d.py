# labels: name::ssl_resnext101_32x4d author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("ssl_resnext101_32x4d", pretrained = pretrained)
model.eval()
