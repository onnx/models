# labels: name::tf_efficientnet_cc_b0_8e author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("tf_efficientnet_cc_b0_8e", pretrained = pretrained)
model.eval()
