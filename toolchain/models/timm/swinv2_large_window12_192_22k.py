# labels: name::swinv2_large_window12_192_22k author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("swinv2_large_window12_192_22k", pretrained = pretrained)
model.eval()
