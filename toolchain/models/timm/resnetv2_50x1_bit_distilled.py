# labels: name::resnetv2_50x1_bit_distilled author::timm task::Computer_Vision license::apache-2.0
import torch
import timm
...
model = timm.create_model("resnetv2_50x1_bit_distilled", pretrained = pretrained)
model.eval()
