...
|A light-weight CNN providing Alexnet <br />level accuracy with 50X fewer<br /> parameters|Deep CNN model which won Imagenet<br /> Challenge in 2014|Deep CNN model which won Imagenet<br /> Challenge in 2015|
