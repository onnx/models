...
|A light-weight CNN providing Alexnet <br />level accuracy with 50X fewer<br /> parameters|Deep CNN model which won <br />Imagenet Challenge in 2014|Very deep CNN model (upto <br />152 layers) which won Imagenet<br /> Challenge in 2015|
