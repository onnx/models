...
|-|-|-|
|<b>[MobileNet](models/image_classification/mobilenet/)</b>|[Sandler et al.](https://arxiv.org/abs/1801.04381)|CNN model that decreasing dimensionality of a layer. Increases efficiency by performing tasks across different model sizes and using shortcut connections between layers. Used for mobile and embedded vision applications.|
|<b>[ResNet](models/image_classification/resnet/)</b>|[He et al.](https://arxiv.org/abs/1512.03385), [He et al.](https://arxiv.org/abs/1603.05027)|CNN model that can support hundreds of Convolutional layers. Uses shortcut connections and solves vanishing gradient problem.|
|<b>[SqueezeNet](models/image_classification/squeezenet/)</b>|[Iandola et al.](https://arxiv.org/abs/1602.07360)|A light-weight CNN easy to deploy. Required less communication across serves. Achieves AlexNet accuracy with 50x parameters.|
...
|<b>[Bvlc_GoogleNet](bvlc_googlenet)</b>|[Szegedy et al.](https://arxiv.org/pdf/1409.4842.pdf)|Deep CNN model(up to 22 layers). Comparatively smaller and faster than VGG and more accurate than AlexNet. Filters can handle multiple object sizes.|
|<b>[Bvlc_reference_CaffeNet](bvlc_reference_caffenet)</b>|[Krizhevsky et al.](https://papers.nips.cc/paper/4824-imagenet-classification-with-deep-convolutional-neural-networks.pdf)|Variant for of AlexNet that provides a clean and modifiable framework for state-of-the-art deep learning algorithms and takes less compute and memory.|
|<b>[Bvlc_reference_RCNN_ILSVRC13](bvlc_reference_rcnn_ilsvrc13)</b>|[Girshick et al.](https://arxiv.org/abs/1311.2524)|Through localization of regions to classify and extract features through the Support Vector Machine (SVM).|
|<b>[DenseNet121](densenet121)</b>|[Huang et al.](https://arxiv.org/abs/1608.06993)|Model where each layer obtains additional inputs from all preceding layers and passes on its own feature providing strong gradient flow and more diversified features.|
|<b>[Inception_v1](inception_v1)</b>|[Szegedy et al.](https://arxiv.org/abs/1409.4842)|Reproduction of GoogleNet that has improved utilization of the computing resources inside the network and helps with the vanishing gradient problem.|
|<b>[Inception_v2](inception_v2)</b>|[Szegedy et al.](https://arxiv.org/abs/1512.00567)|CNN model that helps to reduce the dimensions too much that may causes loss of information thus providing greater accuracy when classifying images.|
|<b>[ShuffleNet](shufflenet)</b>|[Zhang et al.](https://arxiv.org/abs/1707.01083)|Extremely computation efficient CNN model that is designed specifically for mobile devices. Uses pointwise and channel shuffle operations that greatly reduce the computational cost.|
|<b>[ZFNet512](zfnet512)</b>|[Zeiler et al.](https://arxiv.org/abs/1311.2901)|Deep CNN model (up to 8 layers) for Image Classification that tuned the hyperparameters of AlexNet and won the ImageNet Challenge in 2013.|
<hr>
...
|[**Emotion FerPlus**](emotion_ferplus) |[Barsoum et al.](https://arxiv.org/abs/1608.01041)	|FER+ is an enhanced data set with multiple labels for each face image. This dataset can be used to train a deep convolutional neural network (DCNN) from noisy labels, using facial expression recognition as an example.|
...
|Model Class |Reference |Description |
|-|-|-|
|A DNN acoustic model. Used in many natural language technologies.
Represents a probability distribution over all possible word strings in a language|	[Arisoy et al.](https://pdfs.semanticscholar.org/a177/45f1d7045636577bcd5d513620df5860e9e5.pdf)|[contribute](contribute.md)|
<hr>
