...
|A light-weight CNN providing Alexnet <br />level accuracy with 50X fewer<br /> parameters. Top-5 error from <br /> paper - ~20%|Deep CNN model (upto 19 layers) which<br /> won Imagenet Challenge in 2014.<br /> Top-5 error from <br /> paper - ~8%|Very deep CNN model (upto <br />152 layers) which won Imagenet<br /> Challenge in 2015. Top-5 error from <br /> paper - ~6%|
