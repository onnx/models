...
#### INT8 models are generated by [Intel® Neural Compressor](https://github.com/intel/neural-compressor), read the [Introduction](https://github.com/intel/neural-compressor/blob/main/README.md) to know how to use it to quantize ONNX model.
...
|Model Class |Reference |Description |
|-|-|-|
|<b>[MNIST-Handwritten Digit Recognition](vision/classification/mnist)</b>|[Convolutional Neural Network with MNIST](https://github.com/Microsoft/CNTK/blob/main/Tutorials/CNTK_103D_MNIST_ConvolutionalNeuralNetwork.ipynb)	|Deep CNN model for handwritten digit identification|
<hr>
