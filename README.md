...
|-|-|-|
|<b>[MobileNet](models/Image/image_classification/MobileNet)</b>|[Sandler et al.](https://arxiv.org/abs/1801.04381)|Computationally efficient CNN model for mobile and embedded vision applications. <br>Top-5 error from paper - ~10%|
