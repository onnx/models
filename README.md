...
|<b>[SSD-MobileNetV1](vision/object_detection_segmentation/ssd-mobilenetv1)</b>|[Howard et al.](https://arxiv.org/abs/1704.04861)|A variant of Mobilenet that uses the Single Stage Detector(SSD) model framework, and can detect 80 different object classes. Once an image is inputed, the model subsequently converts image pixels to bounding box coordinates that contain each detected object.|
