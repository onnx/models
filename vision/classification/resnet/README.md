...
|ResNet50_fp32| [97.8 MB](model/resnet50-v1-12.onnx) |[92.0 MB](model/resnet50-v1-12.tar.gz)   |1.7.0 |12 |74.97 |92.33 |20.29 |
|ResNet50_int8| [24.6 MB](model/resnet50-v1-12-int8.onnx) |[22.3 MB](model/resnet50-v1-12-int8.tar.gz) |1.7.0 |12 |74.77 |92.32 |11.13 |
> Note the latency depends on the test hardware and the displayed results are collected with Intel® Xeon® Platinum 8280 Processor 1s 4c per instance.
>
> Compared with the fp32 model, the Top-1 accuracy drop ratio is 0.27%, Top-5 accuracy drop ratio is 0.01%  and performance improvement is 1.82x after quantization.
