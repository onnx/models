...
This version is based on the VOC dataset. For an ONNX YOLOv2 Model based on COCO, visit the [YOLOv2 COCO](../yolov2-coco/) page.

|Model|Download| ONNX version |Opset version|
|-----|:-------|:-------------|:------------|
|YOLOv2 - VOC|[203.9 MB](model/yolov2-voc-8.onnx) |1.3  |8 |
